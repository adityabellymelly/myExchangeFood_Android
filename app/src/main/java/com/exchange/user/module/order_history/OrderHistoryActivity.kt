...
class OrderHistoryActivity : BaseActivity<ActivityOrderHistoryBinding, OrderHistoryViewModel>(),OrderHistoryNavigator,CallApi{
    @Inject
    ...
    override fun getBindingVariable(): Int {
        return BR.orderHistoryViewModel
    }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        activityOrderHistoryBinding = getViewDataBinding()
        activityOrderHistoryBinding.recycleOrder.adapter = orderHistoryAdapter
        orderHistoryViewModel.setNavigator(this)
        orderHistoryViewModel.initProgress(this)
        initData()
    }
    override fun onBack() {
        if (intentdata == ConstantCommand.FROM_CHOOSE){
            onBackPressed()
        }else{
    ...
    override fun initData() {
        intentdata= intent?.getStringExtra(ConstantCommand.DATA)?:""
